...
const AdminDashboard: React.FC = () => {
  ...
  const filteredVendors = useMemo(() => {
    ...
    return result;
  }, [vendors, searchQuery, filterComplete, filterType, classifications, sortConfig]);
  ...
  const handleSendDueDiligence = () => {
    ...
    const mailtoLink = `mailto:duediligence@example.com?subject=Vendor Due Diligence Request&body=Please conduct due diligence for the following vendors:%0A%0A${selectedEmails.join('%0A')}`;
  ...
  const stats = useMemo(() => {
    ...
    const complete = vendors.filter(v => v.completionPercentage === 100).length;
    const capex = Array.from(classifications.values()).filter(c => c.vendorType === 'capex').length;
    const opex = Array.from(classifications.values()).filter(c => c.vendorType === 'opex').length;
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="bg-card rounded-xl border border-border p-4 mb-6">
          <div className="flex flex-wrap gap-4">
            ...
            <Select value={filterComplete} onValueChange={(v: any) => setFilterComplete(v)}>
                    ...
                    >
                      ...
                      <td className="p-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm">{vendor.completionPercentage}%</span>
                        </div>
                      </td>
                      <td className="p-4">
                      ...
                      <td className="p-4">
                        {classification?.totalScore !== undefined && (
                          <span className="font-medium">{classification.totalScore}</span>
                        )}
                      </td>
                      <td className="p-4 text-sm text-muted-foreground">
